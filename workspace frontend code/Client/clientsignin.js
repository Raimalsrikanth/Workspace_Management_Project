...
form.addEventListener("submit" ,async (e) => {
    ...
    const response =await fetch(`http://localhost:8080/clientLogin?email=${email.value}&pwd=${pwd.value}`);
    ...
    //   window.open(URL="./index.html","_self");
      window.open(URL="http://127.0.0.1:5500/Client/client_page.html","_self");
    }
    o(); 
  }
